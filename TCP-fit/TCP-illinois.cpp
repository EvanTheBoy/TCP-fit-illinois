...
TCPIllinoisStateVariables::TCPIllinoisStateVariables() {
    // init
    ssthresh = 0xffffffff; /* 15; was UINT32_MAX; */
...
void TCPIllinois::receivedDataAck(uint32 firstSeqAcked) {
    ...
    if (state->lossRecovery) {
         ...
         * the ack in the Linux implementation stands for "next sequence number expected
         * by the receiving TCP" or SEG.ACK.
